...
public interface ReservationGateway {
    ...
    /**
     * Determines if the given vehicle can be rented during the specified time period. It looks for
     * recorded reservations for the same vehicle ID and determines if any of them has a pickup date
     * between the pickup and return dates of the to be submitted time period. If no such
     * reservation is found, the given vehicle can be rented.
     *
     ...
     */
    Optional<Reservation> findByOverlappingRentPeriod(final String vehicleId,
