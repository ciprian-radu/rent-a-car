...
/**
 * Defines the output interface exposed the {@link RegisterVehicleUseCase}. It's the output boundary
...
public interface RegisterVehicleOutputPort {
     ...
     *
     * @param registerVehicleOutputData the output data of the {@link RegisterVehicleUseCase}
