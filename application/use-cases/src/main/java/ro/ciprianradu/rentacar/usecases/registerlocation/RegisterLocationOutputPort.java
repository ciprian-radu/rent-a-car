...
/**
 * Defines the output interface exposed the {@link RegisterLocationUseCase}. It's the output
...
public interface RegisterLocationOutputPort {
     ...
     *
     * @param registerLocationOutputData the output data of the {@link RegisterLocationUseCase}
