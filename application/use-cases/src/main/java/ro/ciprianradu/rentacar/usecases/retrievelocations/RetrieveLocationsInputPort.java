...
/**
 * Defines the input interface exposed the {@link RetrieveLocationsUseCase}. It's the input boundary
 * of mentioned use case.
 */
public interface RetrieveLocationsInputPort {

    /**
     * Allows users of the system to retrieve all the locations from where rented vehicles may be
     ...
     */
    void retrieveLocations(RetrieveLocationsInputData inputData,
        RetrieveLocationsOutputPort outputPort);
