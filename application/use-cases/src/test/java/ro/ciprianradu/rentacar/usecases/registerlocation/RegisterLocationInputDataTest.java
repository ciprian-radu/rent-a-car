...
class RegisterLocationInputDataTest {
    ...
    void test_RegisterLocationInputData_nullName_shouldThrowException() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new RegisterLocationInputData(null, "address"));
    }

    @Test
    void test_RegisterLocationInputData_emptyName_shouldThrowException() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new RegisterLocationInputData("", "address"));
    }

    @Test
    void test_RegisterLocationInputData_name_shouldInstantiate() {
        final RegisterLocationInputData registerLocationInputData = new RegisterLocationInputData("name", "address");
