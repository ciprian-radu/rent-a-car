...
class RetrieveLocationsAdapterTest {
    ...
    public void test_RetrieveLocationsAdapter_null_throwsException() {
        Assertions
            .assertThrows(IllegalArgumentException.class, () -> new RetrieveLocationsAdapter(null));
    }

    @Test
    public void test_RetrieveLocationsAdapter_instantiates() {
        final RetrieveLocationsAdapter registerLocationAdapter = new RetrieveLocationsAdapter(
    ...
    public void test_retrieveLocations_returnsOk() {
        final RetrieveLocationsAdapter registerLocationAdapter = new RetrieveLocationsAdapter(
            new MockRetrieveLocationsInputPort());
        final RetrieveLocationsHttpResponse httpResponse = registerLocationAdapter
            .retrieveLocations();
