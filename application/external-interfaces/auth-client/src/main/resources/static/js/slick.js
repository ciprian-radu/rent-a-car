...
(function (factory) {
    ...
    function Slick(element, settings) {
      ...
      _.defaults = {
        ...
        customPaging: function (slider, i) {
          return $(
              '<button type="button" data-role="none" role="button" tabindex="0" />').text(
              i + 1);
        },
        dots: false,
  ...
  Slick.prototype.addSlide = Slick.prototype.slickAdd = function (markup, index,
      addBefore) {
  ...
  Slick.prototype.buildArrows = function () {
    ...
    if (_.options.arrows === true) {
      ...
      if (_.slideCount > _.options.slidesToShow) {
        ...
        _.$prevArrow.removeClass('slick-hidden').removeAttr(
            'aria-hidden tabindex');
        _.$nextArrow.removeClass('slick-hidden').removeAttr(
            'aria-hidden tabindex');
      ...
      for (a = 0; a < numOfSlides; a++) {
        ...
        for (b = 0; b < _.options.rows; b++) {
          ...
          for (c = 0; c < _.options.slidesPerRow; c++) {
            var target = (a * slidesPerSection + ((b * _.options.slidesPerRow)
                + c));
  ...
  Slick.prototype.getLeft = function (slideIndex) {
    ...
    if (_.options.infinite === true) {
      ...
      if (_.slideCount % _.options.slidesToScroll !== 0) {
        if (slideIndex + _.options.slidesToScroll > _.slideCount && _.slideCount
            > _.options.slidesToShow) {
          if (slideIndex > _.slideCount) {
            _.slideOffset = ((_.options.slidesToShow - (slideIndex
                - _.slideCount)) * _.slideWidth) * -1;
            verticalOffset = ((_.options.slidesToShow - (slideIndex
  ...
  Slick.prototype.getSlideCount = function () {
    ...
    centerOffset = _.options.centerMode === true ? _.slideWidth * Math.floor(
        _.options.slidesToShow / 2) : 0;
  ...
  Slick.prototype.lazyLoad = function () {
    ...
    if (_.slideCount <= _.options.slidesToShow) {
      ...
      cloneRange = _.$slider.find('.slick-cloned').slice(
  ...
  Slick.prototype.removeSlide = Slick.prototype.slickRemove = function (index,
      removeBefore, removeAll) {
  ...
  Slick.prototype.setDimensions = function () {
    ...
    if (_.options.vertical === false && _.options.variableWidth === false) {
      ...
      _.$slideTrack.height(Math.ceil(
          (_.$slides.first().outerHeight(true) * _.$slideTrack.children(
              '.slick-slide').length)));
    }
  ...
  Slick.prototype.setProps = function () {
    ...
    _.transformsEnabled = _.options.useTransform && (_.animType !== null
        && _.animType !== false);
  };
  ...
  Slick.prototype.setSlideClasses = function (index) {
    ...
    if (_.options.centerMode === true) {
      ...
      if (index >= 0 && index <= (_.slideCount - _.options.slidesToShow)) {
        ...
        indexOffset = _.options.infinite === true ? _.options.slidesToShow
            + index : index;

        if (_.options.slidesToShow == _.options.slidesToScroll && (_.slideCount
            - index) < _.options.slidesToShow) {
  ...
  Slick.prototype.slideHandler = function (index, sync, dontAnimate) {
    ...
    if (_.options.infinite === false && _.options.centerMode === false && (index
        < 0 || index > _.getDotCount() * _.options.slidesToScroll)) {
      if (_.options.fade === false) {
  ...
  Slick.prototype.swipeHandler = function (event) {
    ...
    if ((_.options.swipe === false) || ('ontouchend' in document
      ...
      return;
    } else if (_.options.draggable === false && event.type.indexOf('mouse')
        !== -1) {
      return;
    }
  ...
  Slick.prototype.swipeMove = function (event) {
    ...
    touches = event.originalEvent !== undefined ? event.originalEvent.touches
        : null;
    ...
    positionOffset = (_.options.rtl === false ? 1 : -1) * (_.touchObject.curX
    > _.touchObject.startX ? 1 : -1);
    if (_.options.verticalSwiping === true) {
    ...
    if (_.options.vertical === false) {
      ...
      _.swipeLeft = curLeft + (swipeLength * (_.$list.height() / _.listWidth))
          * positionOffset;
    }
    if (_.options.verticalSwiping === true) {
      _.swipeLeft = curLeft + swipeLength * positionOffset;
  ...
  Slick.prototype.updateArrows = function () {
    ...
    if (_.options.arrows === true &&
      ...
      } else if (_.currentSlide >= _.slideCount - 1 && _.options.centerMode
          === true) {
